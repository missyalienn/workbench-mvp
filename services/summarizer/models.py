...
class Source(BaseModel):
    """Grounding reference for a summarizer claim."""
    ...
    excerpt: str = Field(..., description="Verbatim excerpt from the provided evidence")
    supports: str = Field(..., description="Highlight text supported by this source")
...
__all__ = ["PostPayload", "SummarizeRequest", "Source", "SummarizeResult"]
